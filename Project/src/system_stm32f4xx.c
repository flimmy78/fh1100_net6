...
//		//MCO2
//		//PLLI2S N=120 R=2 MCO2/2 50M
//		RCC->PLLI2SCFGR |= (2 << 28); //R=2
//		RCC->PLLI2SCFGR |= (200 << 6); //N=120(180) N=200(168)
//		
//		RCC->CR |= RCC_CR_PLLI2SON;//打开PLLI2
//		
//		while(RCC->CR & RCC_CR_PLLI2SRDY) //等待PLLI2准备好
//		{}
